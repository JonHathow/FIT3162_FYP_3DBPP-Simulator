...
def output_master(packer: Packer):
    ...
    write_output_func(FILE_FITTED_1, filecount + 1, HEADER_OUT_1, rows_fitted)
    write_output_func(FILE_UNFITTED_1, filecount + 1, HEADER_OUT_1, rows_unfitted)
    write_output_func(FILE_OUTBINS_1, filecount + 1, HEADER_OUTBINS_1, rows_bins)
    write_output_func(FILE_SUMMARY_1, filecount + 1, HEADER_SUM, rows_summ)
